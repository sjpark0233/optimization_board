...
<div align=right>
<br>
<font class="font2"> <a href="list_main.jsp">LogOut</a> | <a href="userInfo.jsp">회원정보확인</a> </font>
</div>
  ...
  <tr>
   ...
   <table align="center">
    ...
    <tr>
      ...
      <td width="1000" colspan="2" height="300"></td>
    </tr>
    <tr height="1" bgcolor="#dddddd"><td colspan="4" width="407"></td></tr>
    ...
    <tr align="center">
      <td width="0">&nbsp;</td>
      <td colspan="2" width="399"><input type=button value="글쓰기" OnClick="location.href='write.jsp'">
	<input type=button value="목록" OnClick="location.href='list_in.jsp'">
	<input type=button value="수정" OnClick="location.href='modify.jsp'">
